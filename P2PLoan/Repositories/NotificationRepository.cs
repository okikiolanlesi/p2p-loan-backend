...
public class NotificationRepository : INotificationRepository
{
    ...
    public async Task<Notification> UpdateAsync(Guid notificationId, Guid id, Notification updateNotification)
    {
        ...
        var existingNotification = await dbContext.Notifications
            ...
            // update
            existingNotification.Title = updateNotification.Title;
            existingNotification.Message =updateNotification.Message;
            existingNotification.ModifiedAt = DateTime.UtcNow;
